...
declare interface AceDBFactory {
  ...
  New<T extends Record<string, any> = {}>(
    tbl: string | Record<string, any>,
    defaults?: Partial<AceDBNamespace<T>>,
    defaultProfile?: string | true
  ): AceDB<T>;
}
 ...
 * @see https://www.wowace.com/projects/ace3/pages/api/ace-db-3-0
 */
declare interface AceDB<T extends Record<string, any> = {}>
  extends AceDBNamespace<T> {
  /**
   ...
   * @see https://www.wowace.com/projects/ace3/pages/api/ace-db-3-0
   */
  GetProfiles<T extends Record<string, any> = {}>(tbl?: Record<string, any>): T;
   ...
   * @see https://www.wowace.com/projects/ace3/pages/api/ace-db-3-0
   */
  RegisterNamespace(name: string, defaults: Record<string, any>): void;
...
interface AceDBNamespace<T extends Record<string, any> = {}> {
